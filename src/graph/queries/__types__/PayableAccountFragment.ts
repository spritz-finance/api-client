...
export interface PayableAccountFragment_DebitCard_dataSync {
    __typename: 'AccountDataSync'
    lastSync: any | null
    syncStatus: AccountSyncStatus | null
}

export interface PayableAccountFragment_DebitCard_institution {
...
export interface PayableAccountFragment_DebitCard {
...
export type PayableAccountFragment =
    | PayableAccountFragment_DebitCard
