...
export interface UserPayableAccounts_payableAccounts_DebitCard_dataSync {
    __typename: 'AccountDataSync'
    lastSync: any | null
    syncStatus: AccountSyncStatus | null
}

export interface UserPayableAccounts_payableAccounts_DebitCard_institution {
...
export interface UserPayableAccounts_payableAccounts_DebitCard {
...
export type UserPayableAccounts_payableAccounts =
    | UserPayableAccounts_payableAccounts_DebitCard
