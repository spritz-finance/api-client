...
export interface RenamePayableAccount_renamePayableAccount_DebitCard_dataSync {
    __typename: 'AccountDataSync'
    lastSync: any | null
    syncStatus: AccountSyncStatus | null
}

export interface RenamePayableAccount_renamePayableAccount_DebitCard_institution {
...
export interface RenamePayableAccount_renamePayableAccount_DebitCard {
    ...
    createdAt: any
    dataSync: RenamePayableAccount_renamePayableAccount_DebitCard_dataSync | null
    institution: RenamePayableAccount_renamePayableAccount_DebitCard_institution | null
}
...
export interface RenamePayableAccount_renamePayableAccount_BankAccount {
    ...
    email: string | null
    ownedByUser: boolean
    bankAccountDetails: RenamePayableAccount_renamePayableAccount_BankAccount_bankAccountDetails | null
}
...
export type RenamePayableAccount_renamePayableAccount =
    | RenamePayableAccount_renamePayableAccount_DebitCard
